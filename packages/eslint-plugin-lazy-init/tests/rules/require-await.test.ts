...
async function foo() {
 ...
 `,
      ...
      },
      {
         ...
         code: `
const foo = async function (): Promise<number> {
  lz.fn(() => {})
  return 1;
};
 `,
      ...
      },
      {
         ...
         code: `
const foo = async () => lz.fn(() => {});
`,
         errors: [
            {
               messageId: 'missingAwait',
               data: {
                  name: "Async arrow function 'foo'",
               },
            },
         ],
      },
...
// base typescript-eslint tests
// https://github.com/typescript-eslint/typescript-eslint/blob/8581031278c60cf8a1309cbfc5ee00794daa443b/packages/eslint-plugin/tests/rules/require-await.test.ts
ruleTester.run('require-await', rule, {
   valid: [
